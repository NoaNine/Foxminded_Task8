...
namespace University.WPF
{
    internal class DataSeeder
    {
        ...
        public static void SeedTeachers(DbContext context)
        {
            var teachers = new List<Teacher>
                {
                    new Teacher { GroupId = 1, FirstName = "Олександр", LastName = "Полухін" },
                    new Teacher { GroupId = 2, FirstName = "Василій", LastName = "Моржов" },
                    new Teacher { GroupId = 3, FirstName = "Іван", LastName = "Куклінський" },
                    new Teacher { GroupId = 4, FirstName = "Світлана", LastName = "Савченко" },
                    new Teacher { GroupId = 5, FirstName = "Раїса", LastName = "Халявкіна" },
                    new Teacher { GroupId = 6, FirstName = "Генадій", LastName = "Василенко" },
                    new Teacher { GroupId = null, FirstName = "Петро", LastName = "Моденов" },
                    new Teacher { GroupId = null, FirstName = "Ірина", LastName = "Чуба" },
                    new Teacher { GroupId = null, FirstName = "Анна", LastName = "Колісник" }
                };
